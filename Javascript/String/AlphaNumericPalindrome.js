...
// export default alphaNumericPalindrome for testing
console.log(alphaNumericPalindrome('hello'))
console.log(alphaNumericPalindrome('panama'))
console.log(alphaNumericPalindrome('racecar'))
